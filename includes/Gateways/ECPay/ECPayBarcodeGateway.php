...
class ECPayBarcodeGateway extends ECPayGateway
{
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields['expire_date'] = [
            ...
            'type' => 'number',
            'description' => __('Payment expiry period for convenience store barcode, range 1-60 days', 'woocommerce-omnipay'),
            'default' => '7',
            'desc_tip' => true,
    ...
    protected function preparePaymentData($order)
    {
        ...
        $data['StoreExpireDate'] = (int) $this->get_option('expire_date', 7);
