...
<section class="omnipay-payment-info">
    ...
    <?php if ($submitted_last5) { ?>
        <p>
            <?php echo esc_html__('Last 5 digits of remittance account submitted:', 'woocommerce-omnipay'); ?>
            <strong><?php echo esc_html($submitted_last5); ?></strong>
        </p>
    <?php } else { ?>
        <p><?php esc_html_e('Please enter the last 5 digits of your remittance account after payment to help us confirm the transaction.', 'woocommerce-omnipay'); ?></p>
        <form method="post" action="<?php echo esc_url($submit_url); ?>">
            ...
            <p>
                <label for="remittance_last5"><?php esc_html_e('Last 5 Digits of Remittance Account', 'woocommerce-omnipay'); ?></label>
